...
class signup{
	...
	public function insert($image){
		...
		if($image == false){
			...
			$sql = 'INSERT INTO users (name,email,password,role,image,remaining_emails,pkg_id) VALUES (:name,:email,:password,:role,:image,:remaining_emails,:pkg_id)';
			...
			$stmt->bindValue(':remaining_emails', '20');
			$stmt->bindValue(':pkg_id', '1');
