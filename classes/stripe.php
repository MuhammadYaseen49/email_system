  ...
  class stripe{
    ...
    public function getStripeTokens($data){
      ...
      curl_setopt_array($curl, array(
          ...
          CURLOPT_POST => true,
          CURLOPT_HTTPHEADER => [
              'Authorization: Bearer sk_test_51JoPwHAaMPQGx7NrNDF8lTQPlhu94VifdfNkx9Y9qTvWQigHQab4aFHcZu7mL9Mt6o9Gs77PNom4HZSyqZKi3k6t00qDInhDAn',
    ...
    public function charge_amount($token,$amount,$email){
        $stripe = new \Stripe\StripeClient(
            'sk_test_51JoPwHAaMPQGx7NrNDF8lTQPlhu94VifdfNkx9Y9qTvWQigHQab4aFHcZu7mL9Mt6o9Gs77PNom4HZSyqZKi3k6t00qDInhDAn'
        );
